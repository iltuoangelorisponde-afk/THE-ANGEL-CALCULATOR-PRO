...
const AngelCalculator = () => {
  ...
  const translations = {
    ...
    fr: { title: 'The Angels Calculator', subtitle: 'Découvrez Votre Ange Gardien', firstName: 'Prénom', lastName: 'Nom', email: 'Email', phone: 'Téléphone (optionnel)', birthDate: 'Date de Naissance', promo: 'J\'autorise à être contacté(e) pour recevoir des offres promotionnelles sur les Anges', calculate: 'Calculer Mon Ange', print: 'Imprimer', newSearch: 'Nouvelle Recherche', guardianOf: 'Ange Gardien de', choir: 'CHOEUR', essence: 'ESSENCE', freeVersion: 'Version Gratuite', freeText: 'Ceci est votre Ange Gardien!', fillRequired: 'Remplissez tous les champs obligatoires', footerText: 'Pour des informations sur toutes les autres Consultations Angéliques visitez:', footerDiscover: 'Découvrez Toutes les Consultations Angéliques' },
    es: { title: 'The Angels Calculator', subtitle: 'Descubre Tu Ángel Guardián', firstName: 'Nombre', lastName: 'Apellido', email: 'Email', phone: 'Teléfono (opcional)', birthDate: 'Fecha de Nacimiento', promo: 'Autorizo a ser contactado/a para recibir ofertas promocionales sobre Ángeles', calculate: 'Calcular Mi Ángel', print: 'Imprimir', newSearch: 'Nueva Búsqueda', guardianOf: 'Ángel Guardián de', choir: 'CORO', essence: 'ESENCIA', freeVersion: 'Versión Gratuita', freeText: '¡Este es tu Ángel Guardián!', fillRequired: 'Completa todos los campos obligatorios', footerText: 'Para información sobre todas las otras Consultas Angélicas visita:', footerDiscover: 'Descubre Todas las Consultas Angélicas' },
    de: { title: 'The Angels Calculator', subtitle: 'Entdecke Deinen Schutzengel', firstName: 'Vorname', lastName: 'Nachname', email: 'Email', phone: 'Telefon (optional)', birthDate: 'Geburtsdatum', promo: 'Ich erlaube, für Werbeangebote über Engel kontaktiert zu werden', calculate: 'Berechne Meinen Engel', print: 'Drucken', newSearch: 'Neue Suche', guardianOf: 'Schutzengel von', choir: 'CHOR', essence: 'ESSENZ', freeVersion: 'Kostenlose Version', freeText: 'Dies ist dein Schutzengel!', fillRequired: 'Fülle alle Pflichtfelder aus', footerText: 'Für Informationen über alle anderen Engelberatungen besuche:', footerDiscover: 'Entdecke Alle Engelberatungen' }
  };
