      ...
      <div className="max-w-6xl mx-auto">
        ...
        {showCookieBanner && (
          <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-end md:items-center justify-center p-4">
            <div className="bg-gradient-to-br from-indigo-900 to-purple-900 rounded-3xl p-6 md:p-8 max-w-2xl w-full shadow-2xl border-2 border-purple-400 animate-fade-in">
              <div className="flex justify-between items-start mb-4">
                <h2 className="text-2xl md:text-3xl font-bold">{tc.title}</h2>
                <button onClick={() => setShowCookieBanner(false)} className="text-white/70 hover:text-white transition-all">
                  <X className="w-6 h-6" />
                </button>
              </div>
...
export default AngelCalculator;import React, { useState, useEffect } from 'react';
...
const AngelCalculator = () => {
  ...
  const cookieBannerTranslations = {
    it: {
      ...
      necessaryDesc: 'Essenziali',
      analytics: 'Cookie Analitici',
      analyticsDesc: 'Analisi sito',
      marketing: 'Cookie Marketing',
      marketingDesc: 'Annunci'
    },
    en: {
      title: '🍪 Cookie Usage',
      description: 'We use cookies to improve your experience. Choose which to accept.',
      acceptAll: 'Accept All',
      rejectAll: 'Only Necessary',
      savePreferences: 'Save',
      necessary: 'Necessary Cookies',
      necessaryDesc: 'Essential',
      analytics: 'Analytics Cookies',
      analyticsDesc: 'Site analysis',
      marketing: 'Marketing Cookies',
      marketingDesc: 'Ads'
    },
    fr: {
      title: '🍪 Cookies',
      description: 'Nous utilisons des cookies. Choisissez lesquels accepter.',
      acceptAll: 'Tout Accepter',
      rejectAll: 'Nécessaires',
      savePreferences: 'Sauvegarder',
      necessary: 'Cookies Nécessaires',
      necessaryDesc: 'Essentiels',
      analytics: 'Cookies Analytiques',
      analyticsDesc: 'Analyse',
      marketing: 'Cookies Marketing',
      marketingDesc: 'Publicités'
    },
    es: {
      title: '🍪 Cookies',
      description: 'Usamos cookies. Elige cuáles aceptar.',
      acceptAll: 'Aceptar Todo',
      rejectAll: 'Necesarias',
      savePreferences: 'Guardar',
      necessary: 'Cookies Necesarias',
      necessaryDesc: 'Esenciales',
      analytics: 'Cookies Analíticas',
      analyticsDesc: 'Análisis',
      marketing: 'Cookies Marketing',
      marketingDesc: 'Anuncios'
    },
    de: {
      title: '🍪 Cookies',
      description: 'Wir verwenden Cookies. Wählen Sie.',
      acceptAll: 'Alle',
      rejectAll: 'Notwendige',
      savePreferences: 'Speichern',
      necessary: 'Notwendige',
      necessaryDesc: 'Wesentlich',
      analytics: 'Analytische',
      analyticsDesc: 'Analyse',
      marketing: 'Marketing',
      marketingDesc: 'Werbung'
    }
  };
  ...
  const translations = {
    ...
    es: { 
      ...
      cookieSettings: 'Configuración Cookies'
    },
    de: { 
      title: 'The Angels Calculator', 
  ...
  const angelsDB = [
    ...
    { num: 35, nome: 'CHAVAKHIAH', coro: 'POTESTA', ess
