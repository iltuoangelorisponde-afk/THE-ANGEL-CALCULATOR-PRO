...
const AngelCalculator = () => {
  ...
  const findAngel = (date) => {
    ...
    switch(language) {
      case 'EN': return findAngelEN(m, d);
      case 'FR': return findAngelFR(m, d);
      case 'ES': return findAngelES(m, d);
      case 'DE': return findAngelDE(m, d);
      default: return findAngelIT(m, d);
    }
  };
